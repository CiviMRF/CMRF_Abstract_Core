...
/**
 * @covers \CMRF\Connection\Curl
 * @covers \CMRF\Connection\AbstractCurlConnection
 */
final class CurlTest extends AbstractCurlConnectionTest {

  protected function createConnection(): AbstractCurlConnection {
    return new Curl($this->coreMock, 'test');
  }

  public function testGetType(): void {
    static::assertSame('curl', $this->connection->getType());
  }
